...
cd /u/paloma/R3BRoot/R3BRoot_cabanelas/R3BRoot/build/macros/r3b

# execute root with the defined macro and the command line parameters
$ROOTEXE -q -b /u/paloma/R3BRoot/R3BRoot_cabanelas/R3BRoot/macros/r3b/r3bsim_new.C\($parameters\)
